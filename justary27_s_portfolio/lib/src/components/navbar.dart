...
class Navbar extends AppBar {
  ...
  Navbar({Key? key, required this.navigatorKey}) : super(key: key);
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              "Contact Me",
                                                                              style: GoogleFonts.aBeeZee(textStyle: TextStyle(fontSize: size.width * _cf['taLine'][deviceType])),
                                                                            ),
                                                                            Padding(
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              padding: EdgeInsets.fromLTRB(0, 0.025 * size.height, 0, 0.05 * size.height),
                                                                              child: Row(
