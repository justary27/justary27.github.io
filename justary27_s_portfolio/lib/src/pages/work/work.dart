                        ...
                        title: Text(
                          ...
                          style: GoogleFonts.openSans(
                            textStyle: TextStyle(
                              ...
                              fontSize:
                                  cf['projTitle'][_deviceType] * size.width,
                            ),
                          ),
                        ),
                        subtitle: Text(
                          ...
                          style: GoogleFonts.abel(
                            textStyle: TextStyle(
                              ...
                              fontSize:
                                  cf['projSubtitle'][_deviceType] * size.width,
                        ...
                        subtitle: Text(
                          ...
                          style: GoogleFonts.abel(
                            textStyle: TextStyle(
                              // fontFamily: "Ubuntu",
                              color:
                                  Colors.black.withGreen(200).withOpacity(0.5),
                              fontSize:
                                  cf['projSubtitle'][_deviceType] * size.width,
                              fontStyle: FontStyle.italic,
                              fontWeight: FontWeight.bold,
                            ...
                            children: [
                              ...
                              TextSpan(
                                ...
                                style: TextStyle(
                                  ...
                                  color: const Color.fromRGBO(14, 43, 133, 1.0)
                                      .withOpacity(0.7),
                                  fontSize: cf['projEmphasis'][_deviceType] *
                                      size.width,
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
                              TextSpan(
                                ...
                                style: TextStyle(
                                  fontFamily: "ABeeZee",
                                  color: Colors.white,
                                  fontSize: cf['projDescription'][_deviceType] *
                                      size.width,
                                ),
                              ),
                            ],
                            ...
                            children: [
                              ...
                              TextSpan(
                                ...
                                style: TextStyle(
                                  fontFamily: "CoveredByYourGrace",
                                  color:
                                      const Color.fromRGBO(22, 133, 111, 1.0),
                                  fontSize: cf['projEmphasis'][_deviceType] *
                                      size.width,
                                ),
                              )
